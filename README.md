...
I have learned to build a simple full stack CRUD-app. I know understand how to declare express routes as http handlers, and add logic such as data validation and persistence. I also realised that vanilla JS, HTML and CSS gets you very far.
